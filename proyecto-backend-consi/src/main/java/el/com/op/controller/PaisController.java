...
public class PaisController {
	...
	@PostMapping
	public ResponseEntity<Pais> registrar(@RequestBody Pais p){
		Pais obj = service.registar(p);
		return new ResponseEntity<Pais>(obj,HttpStatus.OK);
	}
	
	@PutMapping
	public ResponseEntity<Pais> actualizar(@RequestBody Pais p){
		Pais obj = service.actualizar(p);
		return new ResponseEntity<Pais>(obj,HttpStatus.OK);
	}
